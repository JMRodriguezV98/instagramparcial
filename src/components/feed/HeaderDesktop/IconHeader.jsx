...
const IconHeader = () => {
    ...
    return (
        <div>
           ...
           <svg style={{..._styleIcon.Icons,..._styleIcon.contentIcons } } aria-label="Inicio" className="_8-yf5 " color="#262626" fill="#262626" height="20" role="img" viewBox="0 0 48 48" width="20">
           ...
           <svg style={{..._styleIcon.Icons,..._styleIcon.contentIcons } } aria-label="Direct" className="_8-yf5 " color="#262626" fill="#262626" height="20" role="img" viewBox="0 0 48 48" width="20">
           ...
           <svg style={{..._styleIcon.Icons,..._styleIcon.contentIcons } } aria-label="Nueva publicación" className="_8-yf5 " color="#262626" fill="#262626" height="20" role="img" viewBox="0 0 48 48" width="20">
            ...
            <svg style={{..._styleIcon.Icons,..._styleIcon.contentIcons } } aria-label="Buscar personas" className="_8-yf5 " color="#262626" fill="#262626" height="20" role="img" viewBox="0 0 48 48" width="20">
            ...
            <svg style={{..._styleIcon.Icons,..._styleIcon.contentIcons } } aria-label="Feed de actividad" className="_8-yf5 " color="#262626" fill="#262626" height="20" role="img" viewBox="0 0 48 48" width="20">
